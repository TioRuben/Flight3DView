...
Drop in a `.gpx`, `.kml`/`.kmz`, `.igc`, or Flightradar24 CSV export and watch the aircraft trace your route across real terrain and imagery — with full play / pause / seek / speed / reverse controls.
...
5. Load another track at any time with the **Load another** button.
